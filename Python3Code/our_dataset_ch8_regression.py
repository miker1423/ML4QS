...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_regression_by_time(dataset, 'heartrate', '2022-06-17 09:30:36',
                                                                                   '2022-06-17 10:30:36', '2022-06-17 11:30:36')
...
basic_features = ['acc_x','acc_y','acc_z','gyr_x','gyr_y','gyr_z',
                  'labelSitting','labelWalking','labelOnTable','labelBiking',
                  'light_lux','mag_x','mag_y','mag_z']
...
dftest = adfuller(dataset['heartrate'], autolag='AIC')

plt.Figure(); autocorrelation_plot(dataset['heartrate'])
DataViz.save(plt)
plt.show()
...
DataViz.plot_numerical_prediction_versus_real(train_X.index, train_y, regr_train_y['heartrate'], test_X.index, test_y, regr_test_y['heartrate'], 'heart rate')
...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_regression(copy.deepcopy(dataset), ['acc_x', 'acc_y'], 0.9, filter=False, temporal=True)
