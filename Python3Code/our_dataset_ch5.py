...
def main():
    ...
    DATASET_FNAME = 'ours_chapter4_result.csv'
    RESULT_FNAME = 'ours_chapter5_result.csv'
    ...
    if FLAGS.mode == 'agglomerative':
        ...
        for k in k_values:
            print(f'k = {k}')
            dataset, l = clusteringH.agglomerative_over_instances(
                dataset, 
                ['acc_x', 'acc_y', 'acc_z'], k, 
                'euclidean', use_prev_linkage=True, link_function='ward')
