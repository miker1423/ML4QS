...
DATASET_PATH = Path('./datasets/ours/')
RESULT_PATH = Path('./intermediate_datafiles/ours/')
RESULT_FNAME = 'ours_result.csv'
...
for milliseconds_per_instance in GRANULARITIES:
    ...
    dataset.add_numerical_dataset('Light.csv', 'time', ['lux'], 'avg', 'light_')

    # We add the magnetometer data (continuous numerical measurements) of the phone and the smartwatch
    # and aggregate the values per timestep by averaging the values
    dataset.add_numerical_dataset('Magnetometer.csv', 'time', ['x','y','z'], 'avg', 'mag_')

    #dataset.add_numerical_dataset('HeartRate.csv', 'time', ['heartrate'], 'avg', 'hr_')
    ...
    # Plot all data
    DataViz.plot_dataset(dataset, ['acc_', 'gyr_', 'light_lux', 'mag_', 'label',],
