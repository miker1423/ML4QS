...
RESULT_FNAME = 'ours_chapter7_classification_result.csv'
EXPORT_TREE_PATH = Path('./figures/ours_dataset_ch7_classification/')
...
basic_features = ['acc_x','acc_y','acc_z',
                  'gyr_x','gyr_y','gyr_z',
...
selected_features = ['acc_y_freq_0.0_Hz_ws_40', 'gyr_x_temp_std_ws_120', 
                     'mag_phone_z_max_freq', 'gyr_y_freq_1.0_Hz_ws_40',
                     'acc_x_freq_1.9_Hz_ws_40',]
